...
const allBlogPosts = [
  ...
  {
    id: '6',
    title: 'Essential Tools for Budget-Friendly DIY Projects',
    imageUrl: 'https://picsum.photos/id/1021/400/250',
    excerpt: 'Starting a DIY project? Here are the must-have tools that won\'t break the bank, ensuring your home improvement tasks are both affordable and successful.',
    date: 'May 20, 2025',
    author: 'Admin',
    category: 'Home & Garden',
  },
  {
    id: '7',
    title: 'Maximizing Your Savings with Online Coupon Extensions',
    imageUrl: 'https://picsum.photos/id/1022/400/250',
    excerpt: 'Never miss a deal again! Learn about browser extensions that automatically find and apply coupons for you, making online shopping effortless and cheaper.',
    date: 'May 15, 2025',
    author: 'Admin',
    category: 'Coupon Guide',
  },
...
const BlogCategoryPage = () => {
  ...
  const postsInCategory = allBlogPosts.filter(post =>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-3 leading-tight" style={{ color: 'var(--main-heading-color)' }}>
            Blogs in Category: {formattedCategoryName}
          </h1>
          <p className="text-base sm:text-lg" style={{ color: 'var(--text-muted)' }}>
            Explore articles and guides related to "{formattedCategoryName}".
          </p>
        </div>
        ...
        {/* No pagination needed for category page (assuming categories might be smaller lists) */}
      </div>
    </div>
  );
};
